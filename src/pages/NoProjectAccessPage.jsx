  ...
  return (
    <main className="no-project-page" aria-label="Створення першої дошки">
      <section className="no-project-card">
        ...
        <p>
          Створіть першу дошку і перетворіть хаос у холодильнику на зрозумілий план: формуйте меню на день,
          зберігайте улюблені рецепти, ведіть спільний список покупок і діліться всім цим із близькими.
        </p>
        <p>
          Початок займе хвилину: придумайте назву дошки, додайте нотатки та, за бажанням,
          одразу запросіть учасників.
        </p>
